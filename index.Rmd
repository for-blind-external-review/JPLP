...
title: |
  ...
  | Hierarchical Point Process Models for Recurring Safety Critical Events Involving Commercial Truck Drivers:
  | A Reliability Framework for Human Performance Modeling
date: July 15, 2020
output: 
  pdf_document:
    toc: true
